...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      <h3 class="heading">What is Physis?</h3>
<!--      <p>Non risus leo sed eget lobortis risus mauris blandit maximus.</p> -->
    </div>
    <p class="btmspace-50 justified">Physis is an offline boutique curated dating and social network for matching high caliber, relationship- minded professionals. 
 
Headquartered in the cool and pleasant city of Bengaluru, Physis serves to offer a physical channel of connecting people, particularly singles. Forget mundane events and awkward moments. We provide modern matchmaking services which are focussed on casual settings, great company. 
